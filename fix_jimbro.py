...
def update_html():
    ...
    social_wrapper = """          <!-- Social Links -->
          <div class="social-links-wrapper" id="jimbro-socials">
    ...
    pattern = r'(<div class="glass-card" id="jimbro-card">.*?</p>)'
    html = re.sub(pattern, r'\1\n' + social_wrapper, html, flags=re.DOTALL)
...
def update_js():
    ...
    js = js.replace("jbroSocials", "jimbroSocials")
    js = js.replace("sandhyaGithubLink", "sandhyaSocials")
    # In line 304, there's jimbroPositioner. Let's make sure it's added.
